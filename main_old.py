...
from torch_geometric.datasets import GeometricShapes, ShapeNet 
...
train_dataset = ShapeNet(root='data/ShapeNet', split="trainval")
train_dataset.transform = T.Compose([SamplePoints(num=256), KNNGraph(k=6)])
test_dataset = ShapeNet(root='data/ShapeNet', split="test")
